...
param_bgColor: Hintergrundfarbe
param_stack: Wieviele Toasts gepuffert werden sollen, (false =1 Toast)
param_align: des Textes im Toast (optional, left, right, center..)
param_position: (optional, bottom-left, bottom-right, top-left, top-right....)
